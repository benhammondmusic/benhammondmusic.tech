...
const Navbar = () => /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs(NavbarTwoColumns, { children: [
  /* @__PURE__ */ jsx("a", { href: "/", children: /* @__PURE__ */ jsx(Logo, { name: "benhammond.tech" }) }),
  /* @__PURE__ */ jsxs(NavMenu, { children: [
    ...
    /* @__PURE__ */ jsx(NavMenuItem, { href: "https://blog.benhammond.tech", children: "Blog" }),
