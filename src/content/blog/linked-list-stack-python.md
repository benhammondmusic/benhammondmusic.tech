---
title: Linked List Stack in Python
description: Implementing a stack data structure using a linked list in Python, exploring classes, the __init__ constructor, and the self keyword while switching from JavaScript to Python.
pubDate: 2021-04-10
---
