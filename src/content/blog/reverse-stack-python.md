---
title: Reverse() a Stack with Python
description: Adding a reverse() method to a Python linked list stack, using a temporary variable to safely swap node pointers without losing track of the remaining list — like not dropping your rope while rock climbing.
pubDate: 2021-04-14
---
