...
description: A working guide to deploying a Django app to Heroku, covering Procfile setup, runtime configuration, required packages like gunicorn and whitenoise, and config vars for production.
pubDate: 2021-04-27
---
