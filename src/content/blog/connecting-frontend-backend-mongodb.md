---
title: Connecting Your Deployed Frontend, Backend and MongoDB Atlas Database
description: A step-by-step guide for wiring up local and deployed versions of a React frontend, Node/Express backend, and MongoDB Atlas database using environment variables and Heroku config vars.
pubDate: 2021-03-31
---
...
In my previous posts, I outlined how to [deploy a Node / Express server backend to Heroku](/blog/deploying-node-express-to-heroku) , and how to  [deploy a React app to a separate Heroku app](/blog/deploying-react-to-heroku). Both of those steps helped us to get most basic "Hello World" version of our client and server apps up and running and connecting to one another. As we add complexity to our apps (OAuth, JWT token authorization, database integration, etc), we will need to do some more work to make a fully deployed version of our web application.
...
Again, assuming you setup your frontend Heroku deployment using  [my previous guide](/blog/deploying-react-to-heroku) :
